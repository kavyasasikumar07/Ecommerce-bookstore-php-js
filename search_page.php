...
if(isset($_POST['add_to_cart'])){
   ...
   $stmt = mysqli_prepare($conn, $check_cart_numbers_query);
   ...
   if(mysqli_num_rows($check_cart_numbers) > 0){
      ...
      $insert_query = "INSERT INTO `cart`(user_id, name, price, quantity, image) VALUES(?, ?, ?, ?, ?)";

      // Prepare the statement
      $stmt = mysqli_prepare($conn, $insert_query);

      // Bind parameters
      mysqli_stmt_bind_param($stmt, "isids", $user_id, $product_name, $product_price, $product_quantity, $product_image);
