...
if(isset($_POST['add_to_cart'])){
   ...
   if(mysqli_num_rows($result) > 0){
      ...
      $insert_product = mysqli_prepare($conn, "INSERT INTO `cart`(user_id, name, price, quantity, image) VALUES(?, ?, ?, ?, ?)");
      mysqli_stmt_bind_param($insert_product, "isids", $user_id, $product_name, $product_price, $product_quantity, $product_image);
...
<section class="home">
   ...
   <div class="content">
      ...
      <p>"Discover literary treasures, door-to-door,
Immerse in stories, forevermore,every page holds a new adventure in store."
...
<section class="home-contact">
   ...
   <div class="content">
      ...
      <p>Inquisitive minds,Feel free to inquire, we're here to explore,
Embark on your journey, let's open the door.</p>
